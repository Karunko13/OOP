...
//Proszę stworzyć klasę reprezentującą tablicę danych, którą można sortować na różne sposoby.

//Zadanie należy wykonać bez żadnych tradycyjnych pętli (nawet w print), 
//lecz z użyciem algorytmów STL. Użycie w kodzie pętli (for, while, do-while) skutkuje niezaliczeniem zadania.
