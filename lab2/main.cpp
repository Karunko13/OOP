...
/*Celem zadania jest napisanie klasy W (wektor n-wymiarowy). Powinien on posiadać wszystkie metody zgodnie z main.cpp, w tym:
...
- operator "+=" dodający do wektora inny wektor lub liczbę
- print do wypisania wektora
- konstruktor przenoszący
Proszę zwrócić uwagę na to, że zdefiniowanie (odkomentowanie w main.cpp) zmiennej preprocesora COMPILATION_ERROR musi skutkować błędem kompilacji - w przeciwnym wypadku -1 punkt za output.
*/
